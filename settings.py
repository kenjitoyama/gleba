...
DATABASE_NAME = 'db_gleba'             # Or path to database file if using sqlite3.
DATABASE_USER = 'gleba_su'             # Not used with sqlite3.
DATABASE_PASSWORD = '8hVWMnvtaxEdZDTq'         # Not used with sqlite3.
